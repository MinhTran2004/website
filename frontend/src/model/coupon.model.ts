...
export default class ModelCoupon {
    ...
    static checkData = ( name:string, category:string, quantity:string, discount:string, value:string, condition:string,image:string, startdate:string, enddate:string, describe:string,
